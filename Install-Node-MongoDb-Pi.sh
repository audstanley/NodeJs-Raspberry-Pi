...
#Next, Creates directory for downloads, and downloads node 7.2.1
cd ~/ && mkdir temp && cd temp && wget https://nodejs.org/dist/latest-v7.x/node-v7.2.1-linux-armv7l.tar.gz;
